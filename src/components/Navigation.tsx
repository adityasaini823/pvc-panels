      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link to="/gallery" className="text-gray-700 hover:text-blue-600">Our Work</Link>            <Link to="/#testimonials" className="text-gray-700 hover:text-blue-600">Testimonials</Link>
